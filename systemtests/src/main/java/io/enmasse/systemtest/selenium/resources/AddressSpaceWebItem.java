...
public class AddressSpaceWebItem extends WebItem implements Comparable<AddressSpaceWebItem> {
    ...
    public AddressSpaceWebItem(WebElement item) {
        ...
        this.name = parseName(webItem.findElement(By.xpath("./td[@data-label='Name/Name Space']")));
        this.namespace = parseNamespace(webItem.findElement(By.xpath("./td[@data-label='Name/Name Space']")));
        this.consoleRoute = parseRoute(webItem.findElement(By.xpath("./td[@data-label='Name/Name Space']")));
